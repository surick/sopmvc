...
import common.exception.user.NullValueException;
...
//        Inet4Address ip4 = Inet4Address.
     ...
     * @return: boolean
     */
    public static boolean isSecurity(UUser uuser) throws UserException, RepeatException, NullValueException {
